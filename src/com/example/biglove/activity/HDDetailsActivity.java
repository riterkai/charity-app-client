...
public class HDDetailsActivity extends BaseActivity implements OnClickListener {
	...
	private void initViews() {
		...
		mEditBtn = (Button) findViewById(R.id.hd_edit_btn);
	   ...
	   // mHdAddress.setText(mHdBean.getaddress());
		...
		mshareBtn.setOnClickListener(new View.OnClickListener() {
		  ...
		  markerImg.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View v) {
					  ...
					  Intent intent = new Intent(HDDetailsActivity.this,TransMapFragment.class);
	...
	public void onClick(View view) {
		...
		case R.id.action_back:
			finish();
			break;
		case R.id.hd_edit_btn:
			Intent intent = new Intent(this, HDEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putParcelable("hdbean", mHdBean);
